...
static CommandLine copy_table_data_command =
	make_command(
		...
		"  --retry-count                 Number of extra attempts on COPY failure (0 = off)\n"
		"  --filters <filename>          Use the filters defined in <filename>\n"
		"  --restart                     Allow restarting when temp files exist already\n"
		"  --resume                      Allow resuming operations after a failure\n"
		"  --not-consistent              Allow taking a new snapshot on the source database\n"
...
static CommandLine copy_indexes_command =
	make_command(
		...
		"  --index-jobs         Number of concurrent CREATE INDEX jobs to run\n"
		"  --restore-jobs       Number of concurrent jobs for pg_restore\n"
		"  --retry-count        Number of extra attempts on CREATE INDEX failure (0 = off)\n"
		"  --filters <filename> Use the filters defined in <filename>\n"
		"  --restart            Allow restarting when temp files exist already\n"
		"  --resume             Allow resuming operations after a failure\n"
		"  --not-consistent     Allow taking a new snapshot on the source database\n",
...
static CommandLine copy_fk_constraints_command =
	make_command(
		...
		"  --retry-count        Number of extra attempts on VALIDATE CONSTRAINT failure (0 = off)\n"
		"  --filters <filename> Use the filters defined in <filename>\n"
		"  --restart            Allow restarting when temp files exist already\n"
		"  --resume             Allow resuming operations after a failure\n"
		"  --not-consistent     Allow taking a new snapshot on the source database\n",
